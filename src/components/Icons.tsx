...
export function SearchIcon({ size = 24, color = '#f3eee6' }: IconProps) {
  return (
...
export function ListDashesIcon({ size = 24, color = '#f3eee6' }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export function BubblesIcon({ size = 28, color = '#f3eee6' }: IconProps) {
  return (
...
export function AddIcon({ size = 28, color = '#f3eee6' }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 28 28" fill="none">
...
export function ProfileIcon({ size = 28, color = '#f3eee6' }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 28 28" fill="none">
...
export function BackIcon({ size = 20, color = '#f3eee6' }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export function BackChevronIcon({ size = 20, color = '#f3eee6' }: IconProps) {
  return (
...
export function CloseIcon({ size = 20, color = '#f3eee6' }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export function TrashIcon({ size = 28, color = '#f3eee6' }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export function PlusIcon({ size = 24, color = '#f3eee6' }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export function EmailIcon({ size = 24, color = '#f3eee6' }: IconProps) {
  return (
...
export function PhoneIcon({ size = 24, color = '#f3eee6' }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
...
export function BirthdayIcon({ size = 24, color = '#f3eee6' }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
...
export function InstagramIcon({ size = 24, color = '#f3eee6' }: IconProps) {
  return (
...
export function TwitterIcon({ size = 24, color = '#f3eee6' }: IconProps) {
  return (
...
export function LinkedInIcon({ size = 24, color = '#f3eee6' }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
...
export function SlackIcon({ size = 24, color = '#f3eee6' }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill={color}>
...
export function NoteIcon({ size = 24, color = '#f3eee6' }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
...
export function SocialIcon({ size = 24, color = '#f3eee6' }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
...
export function MinusIcon({ size = 24, color = '#f3eee6' }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export function BubbleTapIcon({ size = 36, color = '#f3eee6' }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 36 36" fill="none">
      <Circle cx="14" cy="20" r="9" stroke={color} strokeWidth="2.4" />
      <Circle cx="25" cy="12" r="6" stroke={color} strokeWidth="2.4" />
      <Path d="M25 8v8M21 12h8" stroke={color} strokeWidth="2.4" strokeLinecap="round" />
    </Svg>
  );
}

export function ImportCloudIcon({ size = 36, color = '#f3eee6' }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 36 36" fill="none">
      <Path d="M12.5 27H25a7 7 0 0 0 .8-13.95A10 10 0 0 0 7.1 16.2 5.5 5.5 0 0 0 8.5 27h1" stroke={color} strokeWidth="2.4" strokeLinecap="round" strokeLinejoin="round" />
      <Path d="M18 15v12M12.5 21.5L18 27l5.5-5.5" stroke={color} strokeWidth="2.4" strokeLinecap="round" strokeLinejoin="round" />
    </Svg>
  );
}

export function PasteTextIcon({ size = 36, color = '#f3eee6' }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 36 36" fill="none">
...
export function UploadPhotoIcon({ size = 36, color = '#f3eee6' }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 36 36" fill="none">
...
export function ManualEntryIcon({ size = 36, color = '#f3eee6' }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 36 36" fill="none">
...
export function WifiIcon({ size = 24, color = '#f3eee6' }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
